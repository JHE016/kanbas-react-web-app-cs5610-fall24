        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Preheat your oven to 350 degree.</li>
                    <li>Sift together flour, baking powder and salt.</li>
                    <li>Use a mixer to cream the butter together.</li>
                    <li>Stir in the vanilla extract.</li>
                    <li>Add all dry ingredients and mix.</li>
                    <li>Pour the batter evenly into pans.</li>
            ...
            Click
            <a id="wd-github" href="https://github.com/JHE016/kanbas-react-web-app-cs5610-fall24"> this link </a>
            to view code on GitHub<br />
